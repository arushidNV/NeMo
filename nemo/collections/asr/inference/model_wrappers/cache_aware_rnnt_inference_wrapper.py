    ...
    def execute_step(
        ...
        with nvtx_range("CARNNTWrapper_execute_step"):
            ...
            with nvtx_range("CARNNTWrapper_rnnt_decoder_predictions_tensor"):
                # return_text=False skips decode_hypothesis (BPE detokenize), which is
                # wasted work in the Riva niva pipeline -- niva ships raw y_sequence /
                # timestamp / score over DLPack and the C++ rnnt_postprocessor.cc does
                # detokenization on the deltas only. Calling decode_hypothesis here
